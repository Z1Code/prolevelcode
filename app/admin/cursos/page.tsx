...
import { BASIC_MODULES, PRO_MODULES, GAMEDEV_MODULES } from "@/lib/courses/curriculum";
...
export default async function AdminCoursesPage() {
  ...
  return (
    <div className="page-enter">
      ...
      {(() => {
        const curriculumSlugs = new Set([...BASIC_MODULES, ...PRO_MODULES, ...GAMEDEV_MODULES].map((m) => m.defaultSlug));
