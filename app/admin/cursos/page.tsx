    ...
    <div className="page-enter">
          ...
          {GAMEDEV_MODULES.map((mod) => {
            ...
            return (
              <form key={mod.key} action={openCurriculumModule}>
                ...
                <button
                  type="submit"
                  className="group relative w-full overflow-hidden rounded-xl border border-violet-400/[0.12] bg-gradient-to-br from-violet-500/[0.04] via-white/[0.02] to-transparent p-5 text-left transition-all duration-200 hover:border-violet-400/25 hover:shadow-[0_0_24px_rgba(139,92,246,0.08)]"
                >
                  <div className="absolute inset-0 bg-gradient-to-br from-violet-500/[0.06] via-transparent to-transparent opacity-0 transition-opacity duration-300 group-hover:opacity-100" />
                  <div className="relative">
                    <div className="mb-3 flex items-center justify-between">
                      <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-violet-500/10 text-violet-400 transition-colors group-hover:bg-violet-500/15">
                        <CurriculumIcon icon={mod.icon} />
                      </div>
                      <div className="flex items-center gap-2">
                        {course ? (
                    ...
                    <h3 className="text-sm font-semibold text-violet-200 transition-colors group-hover:text-violet-100">
                      {mod.title}
                    </h3>
                    <p className="mt-1.5 text-xs leading-relaxed text-violet-400/40">
                      {mod.description}
                    </p>
                  </div>
                </button>
          ...
          {MARKETING_MODULES.map((mod) => {
            ...
            return (
              <form key={mod.key} action={openCurriculumModule}>
                ...
                <button
                  type="submit"
                  className="group relative w-full overflow-hidden rounded-xl border border-pink-400/[0.12] bg-gradient-to-br from-pink-500/[0.04] via-white/[0.02] to-transparent p-5 text-left transition-all duration-200 hover:border-pink-400/25 hover:shadow-[0_0_24px_rgba(236,72,153,0.08)]"
                >
                  <div className="absolute inset-0 bg-gradient-to-br from-pink-500/[0.06] via-transparent to-transparent opacity-0 transition-opacity duration-300 group-hover:opacity-100" />
                  <div className="relative">
                    <div className="mb-3 flex items-center justify-between">
                      <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-pink-500/10 text-pink-400 transition-colors group-hover:bg-pink-500/15">
                        <CurriculumIcon icon={mod.icon} />
                      </div>
                      <div className="flex items-center gap-2">
                        {course ? (
                          ...
                          <span className="rounded-full border border-pink-400/15 bg-pink-500/[0.06] px-2 py-0.5 text-[10px] font-medium text-pink-400/50">
                            Sin crear
                          </span>
                        )}
                      </div>
                    </div>
                    <h3 className="text-sm font-semibold text-pink-200 transition-colors group-hover:text-pink-100">
                      {mod.title}
                    </h3>
                    <p className="mt-1.5 text-xs leading-relaxed text-pink-400/40">
                      {mod.description}
                    </p>
                  </div>
                </button>
      ...
      <div className="mt-10">
        <div className="mb-4 flex items-center gap-2.5">
          ...
          <span className="rounded-full border border-slate-400/15 bg-slate-500/10 px-2 py-0.5 text-[9px] font-medium tracking-wider text-slate-400">
            COMING SOON
          </span>
          ...
          {AGENTIC_MODULES.map((mod) => {
            ...
            return (
              <form key={mod.key} action={openCurriculumModule}>
                ...
                <button
                  type="submit"
                  className="group relative w-full overflow-hidden rounded-xl border border-slate-300/[0.08] bg-gradient-to-br from-slate-400/[0.04] via-white/[0.02] to-transparent p-5 text-left transition-all duration-200 hover:border-slate-300/20 hover:shadow-[0_0_24px_rgba(148,163,184,0.06)]"
                >
                  <div className="absolute inset-0 bg-gradient-to-br from-slate-300/[0.04] via-transparent to-transparent opacity-0 transition-opacity duration-300 group-hover:opacity-100" />
                  <div className="relative">
                    <div className="mb-3 flex items-center justify-between">
                      <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-slate-300/10 text-slate-300 transition-colors group-hover:bg-slate-300/15">
                        <CurriculumIcon icon={mod.icon} />
                      </div>
                      <div className="flex items-center gap-2">
                        {course ? (
                          ...
                          <span className="rounded-full border border-slate-400/10 bg-slate-500/[0.06] px-2 py-0.5 text-[10px] font-medium text-slate-400/50">
                            Sin crear
                          </span>
                        )}
                      </div>
                    ...
                    <p className="mt-1.5 text-xs leading-relaxed text-slate-400/40">
                      {mod.description}
                    </p>
                  </div>
                </button>
      ...
      {(() => {
        const curriculumSlugs = new Set([...BASIC_MODULES, ...PRO_MODULES, ...GAMEDEV_MODULES, ...MARKETING_MODULES, ...AGENTIC_MODULES].map((m) => m.defaultSlug));
