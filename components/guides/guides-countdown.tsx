...
export function GuidesCountdown({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex flex-col items-center py-24 text-center">
      <h2 className="text-2xl font-semibold">Guias disponibles pronto</h2>
      <p className="mt-2 text-sm text-slate-400">
        Las guias se desbloquean en:
      </p>
